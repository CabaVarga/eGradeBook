...
namespace eGradeBook.Services.Exceptions
{
    ...
    public class UserRegistrationException : Exception
    {
        ...
        public UserRegistrationException(string[] errors, string message) : base(message)
        {
            IdentityErrors = errors;
        }
        ...
        public UserRegistrationException(string[] errors, string message, Exception innerException) : base(message, innerException)
        {
            IdentityErrors = errors;
        }
